...
```
Name: DATABASE_URL
Value: postgresql://postgres:Aupbag7.@db.wdebyxvtunromsnkqbrd.supabase.co:5432/postgres
```
...
- ✅ Database URL: `postgresql://postgres:Aupbag7.@db.wdebyxvtunromsnkqbrd.supabase.co:5432/postgres`
...
3. **VITE_ prefix**: Obligatorio para todas las variables del frontend
