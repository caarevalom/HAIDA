...
{"status":"healthy","timestamp":"2025-12-29T22:21:07.189762"}
...
$ curl https://back.carlosarta.com/api/status
{
  ...
  "version":"2.0.0",
  "uptime":"running",
  "timestamp":"2025-12-29T22:21:25.607517"
}
...
- **CORS**: Configurado para haida.carlosarta.com
...
|-------|-----|----------|--------|
| carlosadmin@hiberus.com | admin | AdminCTB2025Pass | ✅ Activo |
| testprod@hiberus.com | viewer | ViewerPass2025 | ✅ Activo |
| copimiga@gmail.com | viewer | HaidaTest2025Pass | ✅ Activo |
...
- `INDICE-COMPLETO-SESION-2025-12-26.md`
