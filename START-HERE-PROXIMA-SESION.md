...
**Fecha de cierre**: 2025-12-26 15:45
...
2. **Configurar subdominios en Vercel** (haida.carlosarta.com, back.haida.carlosarta.com)
...
3. **[INDICE-COMPLETO-SESION-2025-12-26.md](INDICE-COMPLETO-SESION-2025-12-26.md)** - Índice de todos los archivos
...
8. **[reports/db-inventory-live-20251226-150927.md](/Users/carlosa/Documents/Documentos - MacBook Air de Carlos (2)/HAIDA/reports/db-inventory-live-20251226-150927.md)** - Inventario técnico
...
**Objetivo**: Usar dominio personalizado (haida.carlosarta.com)
...
3. Agregar dominio: haida.carlosarta.com
4. Ir a Vercel Dashboard → haida-one → Settings → Domains
5. Agregar dominio: back.haida.carlosarta.com
6. Actualizar variables de entorno:
   - Frontend: `VITE_API_URL=https://back.haida.carlosarta.com`
   - Backend: `FRONTEND_URL=https://haida.carlosarta.com`
...
Usuario:   carlosadmin@hiberus.com (admin) ✅
```
...
### DNS Configurado
```
haida.carlosarta.com        → CNAME cname.vercel-dns.com (frontend)
back.haida.carlosarta.com   → CNAME cname.vercel-dns.com (backend)
```
...
- [ ] [INDICE-COMPLETO-SESION-2025-12-26.md](INDICE-COMPLETO-SESION-2025-12-26.md) - Ubicación de archivos
