...
const TEST_USERS = [
  { id: 'test-user-1', name: 'Alice QA', email: 'alice@haida.test' },
  { id: 'test-user-2', name: 'Bob Dev', email: 'bob@haida.test' },
  { id: 'test-user-3', name: 'Charlie PM', email: 'charlie@haida.test' }
]
