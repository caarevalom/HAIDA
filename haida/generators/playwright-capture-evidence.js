    ...
    (async () => {
        ...
        const testConfig = {
            ...
            steps: [
                ...
                { description: 'Rellenar email', action: 'fill', selector: 'input[name=email]', value: 'user@test.com' },
                ...
                { description: 'Validar que estamos en home', action: 'assert', selector: 'h1', expected: 'Bienvenido' }
            ]
        };
