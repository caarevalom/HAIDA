...
Status: 200 ✅
{
  ...
  "user": {
    ...
    "email": "trigger-test-979e14a0@haida-test.com",
...
3. **[`tests/web-e2e/auth-api.spec.ts`](tests/web-e2e/auth-api.spec.ts)**
   - Credenciales actualizadas (test-haida@hiberus.com)
...
#   "user": { "id": "...", "email": "nuevo-usuario@haida.com", ... }
# }
```
...
```bash
curl "https://wdebyxvtunromsnkqbrd.supabase.co/rest/v1/users?email=eq.test-haida@hiberus.com" \
