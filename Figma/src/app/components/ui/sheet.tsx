...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Trigger ref={ref} data-slot="sheet-trigger" className={className} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Close ref={ref} data-slot="sheet-close" className={className} {...props} />
));
