...
const MOCK_USER = {
  name: 'Carlos Ruiz',
  email: 'carlos@haida.com',
  role: 'QA Lead',
  avatar: 'https://github.com/shadcn.png',
  department: 'Quality Assurance',
  bio: "Passionate about breaking code so you don't have to.",
};
      ...
      <CardContent className="space-y-8">
        ...
        <div className="flex flex-col items-center justify-center space-y-4">
          <div className="relative group cursor-pointer" onClick={handleAvatarClick}>
            <Avatar
              className={cn(
                'h-32 w-32 border-4 border-background shadow-xl transition-all',
                isEditing && 'group-hover:opacity-75'
              )}
            >
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2 border p-2.5 rounded-md bg-muted/20 h-10">
              ...
              <Badge
                variant="secondary"
                className="ml-auto text-[10px] bg-primary/10 text-primary hover:bg-primary/20"
              >
                Admin
              </Badge>
            </div>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="flex items-center justify-between p-4 border rounded-lg bg-card hover:bg-accent/5 transition-colors">
          <div className="space-y-0.5">
            ...
            <p className="text-sm text-muted-foreground">
              Choose how to open links outside the application.
            </p>
          </div>
          <div className="flex items-center gap-2">
            <select
              ...
              onChange={(e) => {
                ...
                if (val !== 'default') {
                  toast.info(`Preferred browser set to ${val}`, {
                    description:
                      "If not detected, you'll be redirected to the official store for installation.",
                  });
                }
              }}
            >
        ...
        <div className="flex items-center justify-between p-4 border rounded-lg bg-card hover:bg-accent/5 transition-colors">
          <div className="space-y-0.5">
            ...
            <p className="text-sm text-muted-foreground">
              Auto-lock application after 15 minutes of inactivity.
            </p>
          </div>
          <Switch
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-red-700 dark:text-red-500">
                Free up space and resolve local data issues.
              </p>
            </div>
          </div>
          ...
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  This action will clear local data stored by this application in your browser. It
                  will not affect your other browser data. The page will reload after clearing.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="flex items-center justify-between p-4 border rounded-lg bg-card hover:bg-accent/5 transition-colors">
          <div className="space-y-0.5">
            ...
            <p className="text-sm text-muted-foreground">
              Notify when automated test suites complete.
            </p>
          </div>
          <Switch
        ...
        <div className="flex items-center justify-between p-4 border rounded-lg bg-card hover:bg-accent/5 transition-colors">
          <div className="space-y-0.5">
            ...
            <p className="text-sm text-muted-foreground">
              Get notified when a team member assigns a task to you.
            </p>
          </div>
          <Switch
        ...
        <div className="flex items-center justify-between p-4 border rounded-lg bg-card hover:bg-accent/5 transition-colors">
          <div className="space-y-0.5">
            ...
            <p className="text-sm text-muted-foreground">
              Notify when you are mentioned in comments or docs.
            </p>
          </div>
          <Switch
        ...
        <div className="flex items-center justify-between p-4 border rounded-lg bg-card hover:bg-accent/5 transition-colors">
          <div className="space-y-0.5">
            ...
            <p className="text-sm text-muted-foreground">
              Receive weekly summaries of project activity.
            </p>
          </div>
          <Switch
