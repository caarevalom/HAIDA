...
import { AlertCircle, CheckCircle2, Linkedin, Twitter, Instagram, Youtube, Globe, Loader2 } from "lucide-react"
    ...
    try {
      ...
      if (result.success) {
        toast.success("Account Created", {
          description: result.error || `A confirmation email has been sent to ${signUpEmail}. Please verify your account.`
        });
    ...
    <div className="flex flex-col min-h-screen relative overflow-hidden bg-background">
      ...
      <Dialog open={isSignUpOpen} onOpenChange={setIsSignUpOpen}>
        <DialogContent className="sm:max-w-[425px]">
          ...
          <DialogFooter>
            <Button variant="outline" onClick={() => setIsSignUpOpen(false)} disabled={isLoading}>Cancel</Button>
            <Button onClick={handleSignUp} className="bg-primary text-primary-foreground" disabled={isLoading}>
