...
BEGIN
    ...
    SELECT id INTO v_user_id FROM public.users WHERE email = 'carlosadmin@hiberus.com';

    IF v_user_id IS NULL THEN
        -- Buscar en auth.users
        SELECT id INTO v_auth_user_id FROM auth.users WHERE email = 'carlosadmin@hiberus.com';
...
INSERT INTO public.projects (
    ...
    'active',
    (SELECT id FROM public.users WHERE email = 'carlosadmin@hiberus.com'),
...
SELECT
    ...
    is_active AS activo
FROM public.users
WHERE email = 'carlosadmin@hiberus.com';
...
WHERE owner_id = (SELECT id FROM public.users WHERE email = 'carlosadmin@hiberus.com')
