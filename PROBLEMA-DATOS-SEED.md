...
**Fecha**: 2025-12-26
**Usuario afectado**: carlosadmin@hiberus.com
...
- Usuario demo: admin@haida.com, qa@haida.com, dev@haida.com
...
**IMPORTANTE**: Estos datos NO están asignados al usuario `carlosadmin@hiberus.com`.
...
### Para el Usuario carlosadmin@hiberus.com
...
Después de ejecutar el script, el usuario `carlosadmin@hiberus.com` tendrá:
...
DELETE FROM public.users WHERE email IN ('admin@haida.com', 'qa@haida.com', 'dev@haida.com');
...
- Proyectos asignados a carlosadmin@hiberus.com como owner
