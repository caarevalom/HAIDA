...
```json
{
  ...
  "role": "viewer",
  "is_active": false,
  "created_at": "2025-12-26T05:25:41.482078+00:00"
}
```
...
1. **Actualización de credenciales de usuario**:
   - Cambiado de `copimiga@gmail.com` a `test-haida@hiberus.com`
...
```json
{
  ...
  "version": "2.0.0",
  "timestamp": "2025-12-26T05:33:10.959692"
}
```
...
|-------|------|-----------|------|--------|
| test-haida@hiberus.com | Test User HAIDA | Test User HAIDA | viewer | false |
| copimiga@gmail.com | Carlos A | Carlos A | viewer | true |
| caarevalo@hiberus.com | Carlos Arevalo | Carlos Arevalo | viewer | true |
| fnozar@hiberus.com | Fer No | Fer No | viewer | true |
| admin@haida.com | HAIDA Admin | HAIDA Admin | admin | true |
| (7 más usuarios) | ... | ... | ... | ... |
...
**Última actualización**: 2025-12-26 06:35:00 GMT
