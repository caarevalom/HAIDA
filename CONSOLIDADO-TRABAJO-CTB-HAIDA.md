...
**Fecha**: 2025-12-26 (actualizado 14:50)
...
4. **Configurar subdominios Vercel**
   - CNAME ya creados: `haida.carlosarta.com`, `back.carlosarta.com`
...
VITE_APP_URL=https://haida.carlosarta.com
```

#### Backend (back.haida.carlosarta.com)

```bash
vercel domains add back.haida.carlosarta.com --project haida-one
```

**Variables de entorno a actualizar**:
```env
FRONTEND_URL=https://haida.carlosarta.com
ALLOWED_ORIGINS=https://haida.carlosarta.com
```
...
|------------|------------|------------|
| Frontend | https://haida-frontend.vercel.app | https://haida.carlosarta.com |
| Backend | https://haida-one.vercel.app | https://back.haida.carlosarta.com |
| Supabase | https://wdebyxvtunromsnkqbrd.supabase.co | (sin cambio) |
| CTB mcprod | https://mcprod.thisisbarcelona.com | (sin cambio) |

### Credenciales

- **Usuario HAIDA**: carlosadmin@hiberus.com / AdminCTB2025Pass
- **Rol**: admin
