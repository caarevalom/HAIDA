...
**Cambio**: `VITE_API_URL` de `https://haida-one.vercel.app` → `https://haidapi.stayarta.com`
...
```bash
GET /api/health
Response: {"status":"healthy","timestamp":"2025-12-26T15:32:+34662652300"}
Status: ✅ 200 OK
```
...
### Frontend
```
Dominio personalizado: https://haida.stayarta.com
...
### Backend
```
Dominio personalizado: https://haidapi.stayarta.com
...
- [x] DNS CNAME configurados correctamente
  - [x] haida.stayarta.com → cname.vercel-dns.com
  - [x] haidapi.stayarta.com → cname.vercel-dns.com
- [x] Dominio haida.stayarta.com asignado a proyecto correcto (haida-frontend)
- [x] Dominio haidapi.stayarta.com asignado a proyecto correcto (haida-one)
...
curl -s https://haida.stayarta.com/ | grep '<title>'
...
printf '{"email":"hola@stayarta.com","password":"Test1234","full_name":"Test User"}' > /tmp/test.json
curl -X POST https://haidapi.stayarta.com/api/auth/register \
...
# Abrir DevTools → Network → Ver requests a haidapi.stayarta.com
```
...
### Inmediato (Ahora)
1. ✅ **Verificar en navegador**: Abrir https://haida.stayarta.com
