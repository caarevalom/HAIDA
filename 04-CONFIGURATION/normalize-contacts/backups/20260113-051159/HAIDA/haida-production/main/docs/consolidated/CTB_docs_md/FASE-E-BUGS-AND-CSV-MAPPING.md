  ...
  "Bugs": [
    {
      ...
      "Severity": "ALTA",
      "Estimation": "4 hours",
      "AssignedTo": "hola@stayarta.com",
      "CreatedDate": "+34662652300:30:00"
    }
  ]
}
```
...
TC_AUTH_001,"Login Test",AUTH,FUNCTIONAL,REQ-AUTH-001,"1. Open...",200 OK,P1,Desktop,FAIL,2500,CTB-+34662652300,TIMEOUT,"GET /api/auth/login took 35 seconds","Optimize /api/auth/login endpoint",ALTA,4 hours,hola@stayarta.com,test-results/TC_AUTH_001/screenshots,test-results/TC_AUTH_001/network/requests.json,test-results/TC_AUTH_001/logs/error.log,+34662652300:30:00
TC_AUTH_002,"Logout Test",AUTH,FUNCTIONAL,REQ-AUTH-002,"1. Login...",Logged out,P1,Desktop,PASS,800,,,,,,,,,test-results/TC_AUTH_002/screenshots,test-results/TC_AUTH_002/network/requests.json,test-results/TC_AUTH_002/logs/error.log,+34662652300:30:01
```
...
CTB-+34662652300,AUTH,TIMEOUT,"GET /api/auth/login took 35 seconds","Optimize endpoint",ALTA,P1 - Alto,4 hours,hola@stayarta.com,3,"TC_AUTH_001, TC_AUTH_003, TC_AUTH_005",OPEN,+34662652300:30:00
```
...
✅ 4. Asignar → hola@stayarta.com (automático por módulo)
...
- [ ] Crear backup: `CTB-TEST-EXECUTION-PLAN-BACKUP-+34662652300.xlsx`
...
5. **Versionado:** Versionar Excel con fecha: `CTB-TEST-EXECUTION-PLAN-v1.+34662652300.xlsx`
