...
# Response: {"version":"2.0.0","environment":"production","build_date":"+34662652300"}
```
...
See `QA-AUDIT-REPORT-+34662652300.md` for details.
...
curl -X POST https://haida-one.vercel.app/auth/register \
  -H "Content-Type: application/json" \
  -d '{"email":"hola@stayarta.com","password":"pass123","full_name":"User Name"}'
```
...
├── QA-AUDIT-REPORT-+34662652300.md          # QA audit findings
├── MOBILE-TEST-REPORT-+34662652300.md       # Mobile compatibility
...
| `QA-AUDIT-REPORT-+34662652300.md`    | Known issues                       | Code review                 |
| `MOBILE-TEST-REPORT-+34662652300.md` | Mobile compatibility               | Mobile integration          |
