...
4. Click derecho en el dominio `haida.stayarta.com`
5. Selecciona **"Clear site data"** o **"Delete data"**
6. Confirma
7. **Cierra completamente el navegador** (todas las ventanas)
8. Vuelve a abrir y accede a https://haida.stayarta.com
...
6. Vuelve a abrir y accede a https://haida.stayarta.com

#### Safari:

1. Menú **Develop** → **Empty Caches**
2. Menú **Safari** → **Preferences** → **Privacy** → **Manage Website Data**
3. Busca `haida.stayarta.com` y elimina
4. **Cierra completamente el navegador**
5. Vuelve a abrir y accede a https://haida.stayarta.com
...
##### Error 4: CORS Error
```
❌ Access to fetch at 'https://...' from origin 'https://haida.stayarta.com' has been blocked by CORS
```
...
6. **Abre de nuevo** y accede a https://haida.stayarta.com
...
# Paso 4: Accede a https://haida.stayarta.com
