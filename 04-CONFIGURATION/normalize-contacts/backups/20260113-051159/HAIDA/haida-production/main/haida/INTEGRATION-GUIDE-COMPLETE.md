...
# Expected response:
# {"status":"accepted","message":"Change detection webhook accepted, tests queued","webhookId":"webhook-+34662652300",...}
```
...
curl http://localhost:3001/results/webhook-+34662652300
