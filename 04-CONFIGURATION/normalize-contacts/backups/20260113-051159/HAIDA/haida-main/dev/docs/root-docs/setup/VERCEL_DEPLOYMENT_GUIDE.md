...
export DATABASE_URL="postgresql://user:hola@stayarta.com:5432/postgres"
...
```
TELEGRAM_BOT_TOKEN=+34662652300:ABCdefGHIjklMNOpqrsTUVwxyz_1234567890
TELEGRAM_CHAT_ID=+34662652300
```
...
curl -X POST https://haida-one.vercel.app/api/auth/login \
  ...
  -d '{"email":"hola@stayarta.com","password":"test"}'
