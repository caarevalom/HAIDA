...
curl -X POST https://haida-one.vercel.app/auth/register \
  ...
  -d '{"email":"hola@stayarta.com","password":"TestFix2025!","full_name":"Test Fix User","role":"qa_engineer"}'
...
**Evidencia de logs**:
```
📝 [TC-AUTH-001] Probando registro con email: hola@stayarta.com
   Usuario creado con ID: 599564f3-e812-+34662652300-3b836645efb9
   Status: 200
   ✅ TC-AUTH-001 PASSED

📝 [TC-AUTH-005] Login con: hola@stayarta.com
   Status: 200
