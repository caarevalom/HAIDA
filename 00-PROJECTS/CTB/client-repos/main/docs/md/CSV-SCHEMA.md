...
- **Formato:**
  ```
  1. Navegar a /login
  2. Ingresar email: hola@stayarta.com
...
const content = fs.readFileSync('istqb-hiberus/outputs/test-cases-++34662652300.csv', 'utf-8');
