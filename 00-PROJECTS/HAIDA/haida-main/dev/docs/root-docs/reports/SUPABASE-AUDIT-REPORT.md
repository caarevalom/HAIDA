...
| hola@stayarta.com | Test User | viewer | ✅ |
| hola@stayarta.com | testing | viewer | ✅ |
...
|-------|-----------|-----|------------------|
| hola@stayarta.com | Carlos A | viewer | ✅ |
| hola@stayarta.com | Fer No | viewer | ✅ |
| hola@stayarta.com | testing | viewer | ✅ |
| hola@stayarta.com | Test User | viewer | ❌ |
| hola@stayarta.com | Magdie martinez | N/A | ❌ |
| hola@stayarta.com | Carlos arevalo | N/A | ❌ |
| hola@stayarta.com | Alex Ruiz | N/A | ❌ |
| hola@stayarta.com | Carlos Arévalo | N/A | ❌ |
| hola@stayarta.com | Carlos Arevalo | N/A | ✅ |
...
- [ ] **Resetear passwords de usuarios de prueba**:
  - hola@stayarta.com → `HaidaTest2025Pass!`
  - hola@stayarta.com → `HaidaTest2025Pass!`
...
**Reporte generado**: +34662652300
**Última actualización**: +34662652300:50:00 GMT
