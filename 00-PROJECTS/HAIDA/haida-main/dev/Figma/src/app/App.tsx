...
import { Home, Folder, MessageSquare, PenTool, PlayCircle, BarChart3, Users } from 'lucide-react';
...
export default function App() {
  ...
  const renderPage = () => {
    ...
    switch (currentPage) {
      ...
      case 'users':
        return (
          <ProtectedRoute onUnauthorized={handleUnauthorized} requiredRole="admin">
            <UserManagement />
          </ProtectedRoute>
        );
      default:
  ...
  const navItems = [
    ...
    { name: 'Users', value: 'users', icon: <Users className="h-5 w-5" />, adminOnly: true },
