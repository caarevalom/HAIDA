...
export function Documentation() {
  ...
  const docs = [
    {
      id: 1,
      title: 'Getting Started with HAIDA',
      desc: 'Introduction to the testing framework and setup guide.',
      category: 'Guide',
      author: 'Sarah C.',
      updated: '2d ago',
      tags: ['Setup', 'Basics'],
    },
    {
      ...
      desc: 'How to handle OAuth2 tokens in your test scripts.',
      category: 'API',
      author: 'Mike R.',
      updated: '4h ago',
      tags: ['Security', 'Auth'],
    },
    {
      ...
      desc: 'Detailed props and examples for all UI components.',
      category: 'Components',
      author: 'Design Team',
      updated: '1w ago',
      tags: ['UI', 'React'],
    },
    {
      ...
      desc: 'Configuring Jenkins and GitHub Actions pipelines.',
      category: 'DevOps',
      author: 'Alex T.',
      updated: '3d ago',
    ...
    },
    {
      ...
      desc: 'Extend the reporting capabilities with custom logic.',
      category: 'Advanced',
      author: 'Sarah C.',
      updated: '1m ago',
      tags: ['Reporting', 'Node.js'],
    },
  ];
    ...
    <div className="container p-4 md:p-8 space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            className="glass bg-primary text-primary-foreground"
          ...
          <div className="lg:col-span-3 space-y-6">
            <GlassCard className="p-8 min-h-[600px]">
              ...
              <div className="prose dark:prose-invert max-w-none">
                ...
                <p className="lead">
                  Learn how to securely authenticate your automated tests using OAuth2.
                </p>
                  ...
                  {`// cypress.env.json
{
  ...
  "client_secret": "YOUR_SECRET"
                ...
                <p>
                  Use the <code>cy.request()</code> command to obtain the token before your tests
                  run.
                </p>
              </div>
            </GlassCard>
          ...
          <div className="lg:col-span-1 space-y-4">
            <GlassCard className="p-4">
              ...
              <div className="space-y-2 text-sm border-l-2 border-white/10 pl-4">
                <div className="cursor-pointer text-primary border-l-2 border-primary -ml-[18px] pl-4 font-medium">
                  Prerequisites
                </div>
      ...
      {view === 'editor' && (
        <div className="h-[calc(100vh-200px)] grid grid-cols-2 gap-4">
          <GlassCard className="flex flex-col overflow-hidden">
            ...
            <textarea
              className="flex-1 resize-none p-4 bg-transparent border-none focus:outline-none font-mono text-sm"
