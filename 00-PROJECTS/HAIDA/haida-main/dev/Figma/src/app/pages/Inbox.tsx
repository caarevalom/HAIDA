...
export function Inbox() {
  const notifications = [
    {
      id: 1,
      title: 'Test Run Failed: Checkout Flow',
      desc: "The automated test suite 'Checkout' failed at step 3.",
      type: 'system',
      time: '10m ago',
      read: false,
    },
    {
      ...
      desc: "Copilot finished generating the 'User Registration' script.",
      type: 'script',
      time: '1h ago',
      read: false,
    },
    {
      ...
      desc: 'Sarah added 3 new test cases to the project.',
      type: 'project',
      time: '2h ago',
      read: true,
    },
    {
      ...
      desc: 'Your weekly testing summary is ready to view.',
      type: 'system',
      time: '1d ago',
      read: true,
    },
    {
      ...
      desc: 'Scheduled maintenance for tonight at 2 AM EST.',
      type: 'system',
      time: '2d ago',
      read: true,
    },
        ...
        <div className="flex-1 space-y-4">
          {notifications.map((item) => (
            <GlassCard
              key={item.id}
              className={cn(
                'p-4 transition-all hover:bg-white/60 dark:hover:bg-slate-800/60',
