...
test.skip(missingEnv, 'VITE_SUPABASE_URL/VITE_SUPABASE_ANON_KEY are required for realtime tests');
...
// Note: Ejecutar runProductionTests manualmente si se requiere fuera de Playwright.
