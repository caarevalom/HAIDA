...
```json
{
  ...
  "version": "2.0.1",
  "timestamp": "2025-12-26T04:22:++34662652300",
...
| Email | ID | Status |
|-------|----|----|
| hola@stayarta.com | 1c621400-fde4-4baa-a7d2-74141e33c939 | ✅ Registrado |
| hola@stayarta.com | b92004f2-f9ff-4a3f-90ba-15e096b2bc6c | ✅ Registrado |
| hola@stayarta.com | aa481c78-6229-4faa-971f-c11f638a40cc | ✅ Registrado |
| hola@stayarta.com | 4ca6b688-4fce-4345-bfe8-040b2dac9f89 | ✅ Registrado |
| hola@stayarta.com | 7fbad12e-e0df-4d5f-bee6-ec42aa3dfb2e | ✅ Registrado |
| hola@stayarta.com | 8858e0d8-8147-490a-a4c0-0fb8ac81524e | ✅ Registrado |
| hola@stayarta.com | d4825c69-04cf-48b7-b36f-0dc97c5e420a | ✅ Registrado |
| hola@stayarta.com | 8c3dc0e5-cce6-4f14-aa9d-34295a1d0891 | ✅ Registrado |
| hola@stayarta.com | 14b631fb-8435-4af0-853e-9f3f69eb8a4a | ✅ Registrado |

**Metadata de hola@stayarta.com**:
```json
{
...
**Email de prueba**: hola@stayarta.com
...
3. ✅ Microsoft OAuth - Email hola@stayarta.com debe ser válido para Entra
...
2. ❌ Registro de nuevo usuario (hola@stayarta.com)
   - **Razón**: Usuario ya existe (esperado)
   - **Criticidad**: Baja

3. ❌ Login con usuario existente (hola@stayarta.com) y verificar token JWT
...
2. **Resetear Password de Usuario de Prueba**
   - [ ] Usar Supabase Dashboard para resetear password de `hola@stayarta.com`
...
{"email":"hola@stayarta.com","password":"SecurePass123","full_name":"Test User","role":"viewer"}
EOF
```
...
cat <<'EOF' | curl -X POST 'https://haida-one.vercel.app/auth/login' \
  -H 'Content-Type: application/json' -d @-
{"email":"hola@stayarta.com","password":"HaidaTest2025Pass"}
EOF
```
