...
**Problema**: `haida.stayarta.com` servía backend API (JSON) en lugar de React app
**Solución**: Redeployado frontend correctamente desde `/Figma`
**Resultado**:
```bash
curl https://haida.stayarta.com | grep "root"
...
|------------|--------|----------|
| Frontend React | ✅ Operativo | https://haida.stayarta.com |
...
- **Problema detectado**: `haida.stayarta.com` → Backend (Python API)
...
# Content-Type
curl -I https://haida.stayarta.com | grep content-type
✅ content-type: text/html; charset=utf-8
