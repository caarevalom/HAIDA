...
2. **Agregar variable**:
   ...
   - Value: `https://haida.stayarta.com/auth`
...
```json
{
  ...
  "redirect_uri": "https://haida.stayarta.com/auth"  // ← ¡Esto es lo importante!
}
```
...
| **OAuth Callback** | `https://haida.stayarta.com/auth` | ⚠️ Verificar implementación |
