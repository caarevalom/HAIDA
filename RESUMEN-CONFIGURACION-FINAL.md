...
### 2. Usuario de Prueba
- ✅ Usuario creado: `test-haida@hiberus.com`
...
data = {"email": "test@example.com", "password": "Pass123!", "full_name": "Test"}
...
data = {"email": "test-haida@hiberus.com", "password": "HaidaTest2025Pass!"}
r = requests.post(url, json=data)
print(f"Status: {r.status_code}")
...
**Última actualización**: 2025-12-26 06:30
